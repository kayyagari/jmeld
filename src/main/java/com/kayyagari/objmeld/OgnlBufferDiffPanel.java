 ...
 */
public class OgnlBufferDiffPanel extends AbstractContentPanel implements ConfigurationListenerIF, DiffPanelIF {
    ...
    public OgnlBufferDiffPanel(JPanel mainPanel) {
    ...
    public String getTitle() {
        ...
        for (OgnlPanel filePanel : filePanels) {
            if (filePanel == null) {
                continue;
            }
    ...
    private OgnlPanel getFilePanel(AbstractBufferDocument document) {
        for (OgnlPanel fp : filePanels) {
            if (fp == null) {
                continue;
            }
...
//        add(splitPane);
        ...
        if (isShowTree()) {
            ...
            diffTree.addMouseListener(new MouseAdapter() {
                ...
                private void doSelection(JMDelta lineDelta, JMDelta wordDelta) {
                    ...
                    int colEndOffset = 0;
                    try {
                        OgnlPanel leftFilePanel = filePanels[LEFT];
                        OgnlPanel rightFilePanel = filePanels[RIGHT];
    ...
    private OgnlPanel getSelectedPanel() {
    ...
    void setSelectedPanel(OgnlPanel fp) {
        int index;
...
//                toEditor.getDocument().insertString(fromOffset, s, null);
    ...
    public OgnlPanel getFilePanel(int index) {
